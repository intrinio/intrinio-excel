...
Public Sub IntrinioInitialize()
    ...
    If IntrinioRespCode = 200 Then
        ...
        Else
            ...
            login_answer = MsgBox("You reached your Intrinio Subscription Plan Limi", , "Plan Limit Reached")
        End If
    ElseIf IntrinioRespCode = "403" Then
        APICallsAtLimit = True
        'login_answer = MsgBox("You are at your Intrinio Plan Limit", , "Plan Limit Reached")
    Else
        LoginFailure = True
        login_answer = MsgBox("Unable to authenticate with the Intrinio API", , "Unable to Login")
    End If
...
Attribute IntrinioHistoricalData.VB_ProcData.VB_Invoke_Func = " \n19"
    ...
    If ticker <> "" And Item <> "" And LoginFailure = False And APICallsAtLimit = False And coFailure = False Then
        ...
        If HistoricalDataDic.Exists(Key) = False Then
            ...
            ElseIf Response.StatusCode = 403 Then
                APICallsAtLimit = True
                IntrinioHistoricalData = "Plan Limit Reached"
            Else
                IntrinioHistoricalData = ""
            End If
    ...
    Else
        ...
        ElseIf APICallsAtLimit = True Then
            ...
            End If
        ElseIf LoginFailure = True Then
            IntrinioHistoricalData = "Invalid API Keys"
        ElseIf coFailure = True Then
            IntrinioHistoricalData = "Invalid Ticker Symbol"
        Else
            IntrinioHistoricalData = ""
        End If
    End If
